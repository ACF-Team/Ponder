...
function PANEL:Init()
    ...
    self.PlayPauseButton = self:AddButton("ponder/ui/icon64/stop.png", language.GetPhrase("ponder.buttons.pause"), function(btn)
        ...
        btn:SetTooltip(self.UI.Playback.Paused and language.GetPhrase("ponder.buttons.play") or language.GetPhrase("ponder.buttons.pause"))
    end)
